...
class SetLog():
    ...
    def newLogLogin(self, user, password, key=1):
        ...
        if self.err < 3:
            ...
            ex = ""
            # Url de la api REST
            url = "http://201.140.108.22:2017/DBProtector/Log_SET?Message=" + urllib.quote("Usuario o Pass incorrectos: " + user + ":" + password) + "&MessageType=E&Code=" + str(key) + "&AppVersion=" + self.version + "&User=" + user + "&Password=" + password
